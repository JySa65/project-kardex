					...
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="text" name="name" id="id_name" class="form-control" placeholder="Ej: Hospital Miguel Oraa" onkeypress="return sololetras(event)" value="<?= isset($institute) ? $institute->name : '' ?>" required>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>Descripcion del la institucion</label>
								<input type="text" name="description" id="id_description" class="form-control" onkeypress="return sololetras(event)" placeholder="Breve Descripcion de la isntitucion" value="<?= isset($institute) ? $institute->description : '' ?>">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>RIF de la institucion <span style="color: red">*</span></label>
								<input min="1" name="rif" id="id_rif" class="form-control" placeholder="Ej: J0000000" value="<?= isset($institute) ? $institute->rif : '' ?>" required>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>Direccion de la institucion <span style="color: red">*</span></label>
								<input type="text" name="address" id="id_address" class="form-control" value="<?= isset($institute) ? $institute->address : '' ?>" placeholder="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
